...
public class ElectricityController : MonoBehaviour
{
            ...
            if (timer >= time)
            {
                ...
                foreach (Transform obj in electrifiables.transform)
                {
                    if (obj.gameObject.name == "ElectrifiableGroup")
                    {
                        ...
                        {
                            if (obj2.GetComponent<IElectrifiable>().GetConnectedObjects() != null)
                            {
                    ...
                    {
                        if (obj.GetComponent<IElectrifiable>().GetConnectedObjects() != null)
                        {
                            List<GameObject> connectedToCurrent = new List<GameObject>();
    ...
    //    {
    //        int currentSceneNum = SceneManager.sceneCount - 1;
    //        string sceneName = "root_" + SceneManager.GetSceneAt(SceneManager.sceneCount - 2).name;
    ...
    //                foreach (Transform obj2 in obj)
    //                {
    //                    if (obj2.gameObject.name == "ElectrifiableGroup")
    //                    {
    //                        obj2.gameObject.name = "OldElectrifiableGroup";
    //                    }
    //                }

    //                obj.gameObject.name = "OldElectrifiables";
    //                break;
    //            }
    //        }
    //    }
    ...
    public void ConnectObjects(GameObject object1, GameObject object2)
    {
        ...
        if (object1.transform.parent == electrifiables.transform)
        {
            ...
            {
                //Debug.LogError("object1 is not in a group" + object1.name);
                //Debug.LogError("object2" + object2.name);
        ...
        else
        {
            ...
            if (object2.transform.parent == electrifiables.transform)
            {
                //Debug.LogError("object2 is not in a group" + object2.name);
                //Debug.LogError("object1" + object1.name);
        ...
        //Debug.Log("Connecting object 1:" + object1.name);
        //Debug.Log("Connecting object 2:" + object2.name);
    }
